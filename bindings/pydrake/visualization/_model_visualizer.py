...
class ModelVisualizer:
    ...
    def RunWithReload(self, position=None):
        ...
        if position is not None and len(position) > 0:
            ...
            prior_position_map = dict()
            for index, value in enumerate(position):
                prior_position_map[pos_to_name_map[index]] = value
        ...
        while True:
            ...
            # Turn any prior position map into an inner position array.
            inner_position = None
            if prior_position_map is not None:
                ...
                for pos_name, pos_value in prior_position_map.items():
    ...
    def _get_default_positions(self):
        """
        Returns a list of the default position values.
        """
        result = list()
    ...
    def _get_position_to_name_map(self):
        """
        Returns a map of position index -> name.
        """
        result = dict()
